...
#pragma omp threadprivate(gp_input_line, gp_input_line_len, inline_num)
...
#pragma omp threadprivate(token, token_table_size, plot_token)
...
#pragma omp threadprivate(dummy_func)
#ifndef STDOUT
# define STDOUT 1
#endif
...
#pragma omp threadprivate(c_token, num_tokens)
